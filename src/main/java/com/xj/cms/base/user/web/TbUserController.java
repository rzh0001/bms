package com.xj.cms.base.user.web;
...
import com.xj.cms.base.bean.AbstractBean;
import com.xj.cms.base.exception.EnumSvrResult;
import com.xj.cms.base.index.web.BaseController;
import com.xj.cms.base.role.entity.TbRole;
import com.xj.cms.base.role.service.ITbRoleService;
import com.xj.cms.base.user.entity.TbUser;
import com.xj.cms.base.user.service.ITbUserService;
import com.xj.cms.util.EndecryptUtils;
...
public class TbUserController extends BaseController{
    ...
    public String select(Map<String,Object> map,@PathVariable(required=true) Integer userId) {	
		TbUser user = userService.selectUserRole(userId);
		List<TbRole> list = roleService.selectByMap(null);
		map.put("roles", list);
